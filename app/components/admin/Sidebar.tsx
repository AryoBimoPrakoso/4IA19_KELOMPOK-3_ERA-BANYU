    ...
    <aside className="w-64 h-screen bg-white shadow-lg flex flex-col justify-between py-8">
          ...
          return (
            ...
            >
              <Image 
                ...
                width={22} 
                height={22}
                className={`${isActive ? 'brightness-0' : 'brightness-75 group-hover:brightness-0'} transition-all`}
              />
      ...
      <div className="px-6">
        <button
          ...
          className="flex items-center gap-4 px-5 py-3 text-gray-600 hover:bg-red-50 hover:text-red-600 rounded-xl transition-all duration-200 group w-full text-left"
        >
